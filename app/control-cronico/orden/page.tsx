    ...
    return (
      <main className="min-h-screen bg-slate-50 text-slate-900">
        <div className="mx-auto max-w-2xl px-6 py-10">
          <h1 className="text-2xl font-semibold">No hay datos del control crónico</h1>
          <p className="mt-2 text-slate-600">Vuelve a generar una solicitud primero.</p>
          <Link
      ...
      <div className="mx-auto max-w-5xl px-6 py-10 print:max-w-none print:px-0 print:py-0">
        ...
        <section className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-[0_22px_70px_-48px_rgba(15,23,42,0.45)] print:hidden">
          ...
          <div className="mt-6 grid gap-3 text-sm md:grid-cols-2">
            ...
            <Info label="Cambios recientes" value={data.hasRecentChanges ? "Sí" : "No"} />
          ...
          <div className="mt-8 rounded-3xl bg-slate-50 p-5">
            <div className="grid gap-4 md:grid-cols-4">
              ...
              <SummaryCell
                ...
                value={
                  laboratoryTests.length > 0
                    ? displayOrderDetails.sampleTypeLabel
                    : "No aplica"
                }
              />
...
function PrintOrderPage({
  ...
  patient: ChronicControlApiRecord["patient"];
  orderDetails: ReturnType<typeof inferOrderDetails>;
  pageTests: ChronicControlApiRecord["rec"]["tests"];
  issuedAt: string;
...
function chunkTestsForPrint(
  tests: ChronicControlApiRecord["rec"]["tests"],
  category: OrderCategory,
  paperConfig: { bodyHeightMm: number },
) {
  const pages: ChronicControlApiRecord["rec"]["tests"][] = [];
  let currentPage: ChronicControlApiRecord["rec"]["tests"] = [];
  let usedHeight = 0;
...
function estimatePrintItemHeightMm(
  test: ChronicControlApiRecord["rec"]["tests"][number],
  category: OrderCategory,
) {
